...
enum Filter
{
    E(FILTER_NEAREST,								GL_NEAREST,						VK_FILTER_NEAREST),
    E(FILTER_LINEAR,								GL_LINEAR,						VK_FILTER_LINEAR),
};


enum SamplerAddressMode
{
	E(SAMPLER_ADDRESS_MODE_REPEAT,					GL_REPEAT,						VK_SAMPLER_ADDRESS_MODE_REPEAT),
	E(SAMPLER_ADDRESS_MODE_MIRRORED_REPEAT,			GL_MIRRORED_REPEAT,				VK_SAMPLER_ADDRESS_MODE_MIRRORED_REPEAT),
	E(SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE,			GL_CLAMP_TO_EDGE,				VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE),
	E(SAMPLER_ADDRESS_MODE_CLAMP_TO_BORDER,			GL_CLAMP_TO_BORDER,				VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_BORDER),
	E(SAMPLER_ADDRESS_MODE_MIRROR_CLAMP_TO_EDGE,	GL_MIRROR_CLAMP_TO_EDGE,		VK_SAMPLER_ADDRESS_MODE_MIRROR_CLAMP_TO_EDGE),
};

enum ShaderStage
{
    E(SHADER_STAGE_VERTEX,							GL_VERTEX_SHADER,				VK_SHADER_STAGE_VERTEX_BIT),
    E(SHADER_STAGE_TESSELLATION_CONTROL,			GL_TESS_CONTROL_SHADER,			VK_SHADER_STAGE_TESSELLATION_CONTROL_BIT),
    E(SHADER_STAGE_TESSELLATION_EVALUATION,			GL_TESS_EVALUATION_SHADER,		VK_SHADER_STAGE_TESSELLATION_EVALUATION_BIT),
    E(SHADER_STAGE_GEOMETRY,						GL_GEOMETRY_SHADER,				VK_SHADER_STAGE_GEOMETRY_BIT),
    E(SHADER_STAGE_FRAGMENT,						GL_FRAGMENT_SHADER,				VK_SHADER_STAGE_FRAGMENT_BIT),
    E(SHADER_STAGE_COMPUTE,							GL_COMPUTE_SHADER,				VK_SHADER_STAGE_COMPUTE_BIT),
};
